...
const ProfileSection = ({ fullName, phoneNumber, email, profileImageUrl, onUpdateSuccess }) => {
    ...
    return (
        ...
        {/* Profile Section */}
        <div className="flex flex-col items-center w-full max-w-md p-6 pb-4 text-center"> {/* Removed background and shadow classes */}
            <img
            ...
            {isEditing ? (
                <div className="flex mt-4 space-x-4">
                    <button onClick={handleCancel} className="px-4 py-2 bg-gray-200 rounded-lg hover:bg-gray-300">Hủy</button>
                    <button
                ...
                <button onClick={handleEdit} className="px-4 py-2 mt-4 bg-gray-200 rounded-lg hover:bg-gray-300">Chỉnh sửa</button>
            )}
    
            {/* Logout Button */}
            <button onClick={handleLogout} className="px-4 py-2 mt-4 text-white bg-red-500 rounded-lg hover:bg-red-600">Đăng xuất</button>
