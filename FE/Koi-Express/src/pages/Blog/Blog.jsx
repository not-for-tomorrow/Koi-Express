                        ...
                        element={
                            <>
                                ...
                                <div className="flex flex-wrap gap-3 mb-8">
                                    <button className="px-4 py-2 font-semibold text-white bg-blue-500 rounded-full">Tất
                                        cả tin tức
                                    </button>
                                    <button
                                        className="px-4 py-2 font-semibold bg-gray-200 rounded-full hover:bg-blue-500 hover:text-white">Khách
                                        hàng
                                    </button>
                                    <button
                                        className="px-4 py-2 font-semibold bg-gray-200 rounded-full hover:bg-blue-500 hover:text-white">Tài
                                        xế
                                    </button>
                                    <button
                                        className="px-4 py-2 font-semibold bg-gray-200 rounded-full hover:bg-blue-500 hover:text-white">Đồng
