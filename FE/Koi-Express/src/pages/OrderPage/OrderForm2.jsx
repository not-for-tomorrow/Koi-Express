  ...
  return (
    <div className="relative z-20 flex flex-col w-1/3 h-full p-10 bg-white border-r border-gray-200 shadow-lg">
      ...
      <div className="flex flex-col justify-between flex-grow space-y-6">
        ...
        <div className="mb-4 border-b border-gray-300 shadow-sm"></div>
        ...
        <div className="p-3 transition duration-300 bg-white rounded-lg shadow-md hover:shadow-lg">
        ...
        <div className="flex items-center p-3 space-x-4 transition duration-300 bg-white rounded-lg shadow-md hover:shadow-lg">
          <input
            type="checkbox"
        ...
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
          <div className="flex flex-col justify-between">
            <div className="flex items-center justify-between p-3 transition duration-300 bg-gray-100 rounded-lg shadow-md hover:shadow-lg">
              {/* Thời gian lấy hàng */}
            ...
            <div className="relative p-3 mt-3 transition duration-300 bg-gray-100 rounded-lg shadow-md hover:shadow-lg">
              {/* Mã khuyến mãi */}
              <label className="block text-xs font-medium text-gray-500">
                Mã khuyến mãi
              </label>
          ...
          <div className="p-3 transition duration-300 bg-gray-100 rounded-lg shadow-md hover:shadow-lg">
            {/* Ghi chú cho tài xế */}
            <label className="block text-xs font-medium text-gray-600">
              Ghi chú cho tài xế
            </label>
            <textarea
              ...
              className="w-full h-16 mt-1 bg-gray-100 outline-none"
        ...
        <div className="flex flex-col items-center justify-between p-3 transition duration-300 bg-white rounded-lg shadow-md sm:flex-row hover:shadow-lg">
          {/* Hình thức thanh toán */}
      ...
      {/* Submit Button */}
      <button className="w-full p-3 text-white bg-blue-500 rounded-lg shadow-lg hover:bg-blue-600">
        Đặt đơn
      </button>
    </div>
  );
