...
function DashboardStartGrid() {
    return(
        <div className='flex gap-4 w-full'>
            ...
            <BoxWrapper>
                <div className="rounded-full h-12 w-12 flex items-center justify-center bg-amber-700">
                    <IoBagHandle className="text-2xl text-white" />
                </div>
            ...
            <BoxWrapper>
                <div className="rounded-full h-12 w-12 flex items-center justify-center bg-emerald-800">
                    <IoBagHandle className="text-2xl text-white" />
                </div>
