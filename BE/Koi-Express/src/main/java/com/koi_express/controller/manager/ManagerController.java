...
public class ManagerController {
    ...
    public ResponseEntity<ApiResponse<Customers>> getCustomerByPhoneNumber(
    ...
    public ResponseEntity<ApiResponse<List<DeliveringStaff>>> getAllDeliveringStaff() {
        ...
        return ResponseEntity.ok(ApiResponse.success("Delivering staff retrieved successfully.", deliveringStaffAccounts));
    }
    ...
    public ResponseEntity<ApiResponse<BigDecimal>> getTotalAmountPerDay() {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success("Total amount for " + latestDate + " retrieved successfully", totalAmount));
        } catch (Exception e) {
    ...
    public ResponseEntity<ApiResponse<BigDecimal>> getTotalAmount() {
        try {
            ...
            return ResponseEntity.badRequest()
                    .body(ApiResponse.badRequest("Error retrieving total amount"));
        }
    }
    ...
    public ResponseEntity<ApiResponse<Integer>> getNumberOfCustomers() {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success("Number of customers retrieved successfully", numberOfCustomers));
        } catch (Exception e) {
            return ResponseEntity.badRequest()
                    .body(ApiResponse.badRequest("Error retrieving number of customers"));
        }
    }
